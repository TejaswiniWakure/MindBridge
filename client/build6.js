...
const files = {
  'src/layouts/TherapistLayout.jsx': `import React from 'react';
...
export const TherapistLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Clients', path: '/therapist/clients', icon: Users },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-64 bg-primary text-white flex flex-col h-screen sticky top-0">
        <div className="p-6 flex items-center gap-2">
          ...
          <span className="text-xl font-bold font-serif">Mindwell Pro</span>
        </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                \`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors \${
                  isActive ? 'bg-primary-dark text-white font-medium' : 'text-gray-300 hover:bg-primary-dark/50'
                }\`
              }
            >
        ...
        <div className="p-4 border-t border-primary-dark">
          <button onClick={logout} className="flex items-center gap-3 px-3 py-2 w-full rounded-lg text-gray-300 hover:bg-primary-dark/50 transition-colors">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-end px-8 sticky top-0 z-10">
          <div className="h-8 w-8 bg-teal text-white rounded-full flex items-center justify-center font-medium">
