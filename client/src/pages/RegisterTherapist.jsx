...
import { UserCheck, Mail, Lock, User, Phone, Clipboard, Award, ShieldAlert, HeartHandshake } from 'lucide-react';
...
const RegisterTherapist = () => {
  ...
  const onSubmit = (data) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('mindbridge_onboarding_role', 'therapist');
      navigate('/verify-email');
    }, 1500);
  };

  const specializationOptions = [
    { label: 'Adolescent Counseling', value: 'adolescent-counseling' },
      ...
      <div className="max-w-xl w-full mx-auto">
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center text-center gap-2">
            ...
            <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-950/40 text-amber-650 dark:text-amber-400 text-[10px] font-bold uppercase tracking-wide">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500">
              Support families, manage clinical logs, and build communication.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <Button
              type="submit"
              variant="outline"
              className="w-full py-3 rounded-xl mt-2 font-semibold text-sm border-amber-500 text-amber-700 hover:bg-amber-50 dark:hover:bg-slate-800"
              isLoading={loading}
            >
              Register & Continue
            </Button>
