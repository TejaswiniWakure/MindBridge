...
import { Sparkles, Mail, Lock, User, Phone, Calendar, School, HeartHandshake } from 'lucide-react';
...
const RegisterTeen = () => {
  ...
  const onSubmit = (data) => {
    ...
    setTimeout(() => {
      ...
      // Store temporary role in localStorage to guide onboarding flow
      localStorage.setItem('mindbridge_onboarding_role', 'teen');
      ...
      <div className="max-w-xl w-full mx-auto">
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center text-center gap-2">
            ...
            <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 text-indigo-750 dark:text-indigo-400 text-[10px] font-bold uppercase tracking-wide">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500">
              Welcome to your private wellbeing space. Let's get you set up.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <Input
              ...
              id="school"
              placeholder="e.g. Westside Senior High School"
              icon={School}
              error={errors.school}
              {...register('school', {
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-4 text-center flex flex-col gap-2">
            ...
            <span className="text-xs text-slate-450">
              Selected wrong role?{' '}
              <Link to="/choose-role" className="text-teal-600 hover:underline font-bold">
